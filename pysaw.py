...
# ==================================================
# pysaw framework command line interface logic
# @version: 1.0.0
...
# ==================================================
pysaw_logo = __load_txt_resource__(TXT_RESOURCES_PATH + 'pysaw_logo.txt').read()
...
# ==========================================================
    ...
    print(pysaw_logo)
    print("")
    print("python pysaw.py run --port=port - runs the application on the specified port")
    print("python pysaw.py create page PageName page-url - creates a page")
    print("python pysaw.py create resource ResourceName resource-url - creates a standard rest api")
# ==========================================================
#
# Error handling
#
# ==========================================================
    ...
    throw_error('pysaw needs at least 3 arguments for options please see --help')
